...
Only Virtual APIs with **Listed Open** visibility appear in the Global Marketplace. This is the most open discovery setting — the agent card and registry listing are public, and the current relay endpoint still requires a marketplace key for data access.
