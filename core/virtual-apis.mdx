...
<Info>
  If your upstream API serves Markdown, set `input_format: markdown` when the upstream `Content-Type` is missing or unreliable. See [Markdown](../delivery/markdown) for document-mode normalization, front matter rules, and limitations.
</Info>
