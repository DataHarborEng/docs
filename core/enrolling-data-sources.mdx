...
When you provide upstream credentials during enrollment, DataHarbor stores that secret material in **Azure Key Vault** rather than embedding it in the Virtual API Configuration.
