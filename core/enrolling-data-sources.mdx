...
DataHarbor uses this template to understand your API's resource hierarchy. Each static segment (like `customers`, `orders`, `items`) becomes a matchable object name in your [Virtual API spec](/core/virtual-apis#object-definitions-and-route-matching).
