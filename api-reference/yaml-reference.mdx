...
| `input_format` | string | Optional. Expected upstream format. Values: `json`. Auto-detected if omitted |
| `default_output_format` | string | Optional. Desired response format. Values: `json`, `markdown`, `csv`, `yaml`. Preserves input format if omitted |
